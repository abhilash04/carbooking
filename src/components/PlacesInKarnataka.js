...
import blr from "../../src/assets/bengaluru.png";
import coorg from "../../src/assets/coorg.png";
import nandi from "../../src/assets/nandi_hills.png";
import chk from "../../src/assets/chikmagalur.png";
import mys from "../../src/assets/mysore.png";
import mur from "../../src/assets/murudeshwar.png";

/* ----------------------------
   Data
----------------------------- */
const PLACES = [
  { id: "blr", title: "Bengaluru", img: blr },
  { id: "coorg", title: "Coorg", img: coorg },
  { id: "nandi", title: "Nandi Hills", img: nandi },
  { id: "chk", title: "Chikkamagaluru", img: chk },
  { id: "mys", title: "Mysuru", img: mys },
  { id: "mur", title: "Murudeshwar", img: mur },
];
...
/* ----------------------------
   Component
----------------------------- */
export default function PlacesInKarnataka() {
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Check out the most popular places in Karnataka.
          </Typography>
        </Box>
